      ...
      <div className="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 bg-zinc-900 border border-zinc-700/60 rounded-lg shadow-2xl p-5">
        ...
        {step === 'github' && (
          ...
          >
            ...
            {error && (
              <div className="text-xs text-red-400 bg-red-400/10 border border-red-400/20 rounded-md p-2 break-words">{error}</div>
            )}
        ...
        {step === 'manual' && (
          ...
          >
            {error && (
              <div className="text-xs text-rose-400 bg-rose-500/10 px-3 py-2 rounded">{error}</div>
            )}
            <div>
